...
export const eventDb: Record<string, Event> = {
  ...
  "winter-of-code-2024-25": {
    ...
    category: "Challenge",
    sortDate: "2024/12/17",
    displayDate: "17/12/2024 - 05/03/2025",
  ...
  "git-github-foundations-workshop": {
    ...
    details: "2nd July 2025 | Seminar Hall, Academic Block 3",
    report:
  ...
  "how-to-win-a-hackathon": {
    ...
    category: "Workshop",
    sortDate: "2025/07/03",
    displayDate: "03/07/2025",
    details: "3rd July 2025 | Seminar Hall, Academic Block 3",
    report:
  ...
  "gen-ai-workshop": {
    ...
    category: "Workshop",
    sortDate: "2025/07/17",
    displayDate: "17/07/2025",
    details: "17th July 2025 | Anugraha Hall, Academic Block 3",
    report:
  ...
  "bootstrap-2025": {
    ...
    mainImage: "/events/acmsc-induction-2025/acmsc-induction-2025-1.jpg",
    stats: [{ prefix: "Welcomed Over  ", value: 180, suffix: " Students" }],
    gallery: [
      "/events/acmsc-induction-2025/acmsc-induction-2025-2.jpg",
      "/events/acmsc-induction-2025/acmsc-induction-2025-3.jpg",
      "/events/acmsc-induction-2025/acmsc-induction-2025-4.jpg",
      "/events/acmsc-induction-2025/acmsc-induction-2025-5.png",
    ],
